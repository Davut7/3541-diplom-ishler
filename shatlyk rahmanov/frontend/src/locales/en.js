export default {
  ...
  statistics: {
    ...
    subtitle: 'Comprehensive overview of firewall performance and threat analysis',
    summary: {
    ...
    charts: {
      ...
      activityTimeline: '24-Hour Activity Timeline'
    },
    aiPerformance: {
