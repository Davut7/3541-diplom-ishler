...
# ============================================
# KeyGuard - PM2 Start Script
# Author: Rowshen Orazmuhammedow
# ============================================

APP_NAME="rowshen-keyguard"
...
# Start backend
echo -e "${GREEN}Starting backend on port 7013...${NC}"
cd "$SCRIPT_DIR/backend"
pm2 start npm --name "${APP_NAME}-backend" -- start

# Start frontend
echo -e "${GREEN}Starting frontend on port 7014...${NC}"
...
echo "║                                                              ║"
echo "║  Frontend: http://localhost:7014                             ║"
echo "║  Backend:  http://localhost:7013                             ║"
echo "║                                                              ║"
