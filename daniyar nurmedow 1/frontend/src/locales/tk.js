export default {
  ...
  liveLab: {
    title: 'Janly XSS Laboratoriýasy',
    subtitle: 'Hakyky ejiz formalarda we daşarky türgenleşik sahypalarynda türgenleşiň',
    warning: 'Bu sahypada bilim maksatly niýetlenip döredilen ejiz formalar bar. Diňe rugsat berlen ulgamlarda türgenleşiň!',
    reflectedDemo: {
      title: 'Şöhlelendirilen XSS Demo',
      desc: 'Girişi arassalamadan şöhlelendirýän gözleg formasy',
      searchLabel: 'Gözleg',
      searchPlaceholder: 'Synap görüň: <img src=x onerror=alert(1)>',
      searchBtn: 'Gözle',
      results: 'Gözleg netijeleri:'
    },
    storedDemo: {
      title: 'Saklanýan XSS Demo',
      desc: 'Girişi howpsuz däl usulda saklaýan we görkezýän teswir formasy',
      nameLabel: 'Adyňyz',
      commentLabel: 'Teswir',
      submitBtn: 'Teswir Goý',
      clearBtn: 'Teswirleri Arassala',
      commentsTitle: 'Teswirler'
    },
    domDemo: {
      title: 'DOM-esasly XSS Demo',
      desc: 'URL hash-yny howpsuz däl usulda işleýän klient tarapy JavaScript',
      instruction: 'URL-a #<img src=x onerror=alert(1)> goşup synap görüň',
      hashValue: 'Häzirki hash bahasy:'
    },
    trainingSites: {
      title: 'Türgenleşik Sahypalary',
      desc: 'Bu rugsat berlen ejiz programmalarynda XSS türgenleşiň',
      sites: {
        google: 'Google XSS Game - XSS-i ädim-ädim öwreniň',
        portswigger: 'PortSwigger Web Security Academy - Professional türgenleşik',
        owasp: 'OWASP WebGoat - OWASP resmi türgenleşik',
        dvwa: 'DVWA - Damn Vulnerable Web Application',
        hackthebox: 'HackTheBox - CTF kynçylyklary',
        xssgame: 'XSS Game - Interaktiw XSS kynçylyklary'
      }
    },
    payloadsCheatsheet: {
      title: 'XSS Ýükleri Şpargalkasy',
      copy: 'Kopiýala'
    }
  },
  about: {
