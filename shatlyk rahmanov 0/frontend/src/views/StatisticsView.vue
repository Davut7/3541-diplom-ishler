<template>
  <div class="statistics-view">
    <div class="page-header">
      ...
      <Button icon="pi pi-refresh" label="Refresh" @click="refreshData" :loading="loading" />
    </div>
    ...
    const refreshData = async () => {
      ...
      try {
        ...
        if (response.data.success) {
          ...
          summaryStats.value.totalThreats.value = stats.overview.threatsBlocked.toLocaleString()
          summaryStats.value.blockedAttacks.value = stats.overview.threatsBlocked.toLocaleString()
          summaryStats.value.activeRules.value = stats.overview.rulesActive
          aiMetrics.value.accuracy = stats.overview.aiAccuracy
        }
      } catch (error) {
