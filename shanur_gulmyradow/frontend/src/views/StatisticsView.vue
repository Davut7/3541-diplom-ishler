...
export default {
  ...
  setup(props) {
    ...
    const generateStatistics = () => {
      const totalPackets = Math.floor(Math.random() * 500000) + 100000
      const totalBytes = totalPackets * (Math.floor(Math.random() * 800) + 200)
      const duration = Math.floor(Math.random() * 7200) + 3600

      return {
        summary: {
          totalPackets,
          totalBytes,
          packetsPerSecond: Math.floor(totalPackets / duration),
          bytesPerSecond: Math.floor(totalBytes / duration),
          captureTime: `${Math.floor(duration / 3600)}h ${Math.floor((duration % 3600) / 60)}m`,
          avgPacketSize: Math.floor(totalBytes / totalPackets)
        },
        protocols: {
          TCP: { packets: 45 + Math.floor(Math.random() * 10), color: '#00d4aa' },
          UDP: { packets: 20 + Math.floor(Math.random() * 8), color: '#7c3aed' },
          HTTP: { packets: 10 + Math.floor(Math.random() * 5), color: '#10b981' },
          HTTPS: { packets: 12 + Math.floor(Math.random() * 6), color: '#3b82f6' },
          DNS: { packets: 5 + Math.floor(Math.random() * 3), color: '#f59e0b' },
          ICMP: { packets: 2 + Math.floor(Math.random() * 2), color: '#6b7280' },
          SSH: { packets: 3 + Math.floor(Math.random() * 2), color: '#14b8a6' }
        },
        packetSizes: {
          '0-64': Math.floor(Math.random() * 15000) + 5000,
          '65-128': Math.floor(Math.random() * 20000) + 8000,
          '129-256': Math.floor(Math.random() * 25000) + 10000,
          '257-512': Math.floor(Math.random() * 18000) + 7000,
          '513-1024': Math.floor(Math.random() * 12000) + 5000,
          '1025-1500': Math.floor(Math.random() * 8000) + 3000
        },
        topPorts: [
          { port: 443, name: 'HTTPS', connections: Math.floor(Math.random() * 5000) + 2000 },
          { port: 80, name: 'HTTP', connections: Math.floor(Math.random() * 3000) + 1000 },
          { port: 22, name: 'SSH', connections: Math.floor(Math.random() * 500) + 200 },
          { port: 53, name: 'DNS', connections: Math.floor(Math.random() * 800) + 300 },
          { port: 3306, name: 'MySQL', connections: Math.floor(Math.random() * 300) + 100 }
        ],
        topTalkers: [
          { rank: 1, ip: '192.168.1.100', hostname: 'workstation-01', packetsIn: Math.floor(Math.random() * 50000) + 20000, packetsOut: Math.floor(Math.random() * 40000) + 15000, bytesIn: Math.floor(Math.random() * 50000000) + 20000000, bytesOut: Math.floor(Math.random() * 40000000) + 15000000 },
          { rank: 2, ip: '192.168.1.50', hostname: 'server-main', packetsIn: Math.floor(Math.random() * 40000) + 15000, packetsOut: Math.floor(Math.random() * 35000) + 12000, bytesIn: Math.floor(Math.random() * 40000000) + 15000000, bytesOut: Math.floor(Math.random() * 35000000) + 12000000 },
          { rank: 3, ip: '8.8.8.8', hostname: 'dns.google', packetsIn: Math.floor(Math.random() * 30000) + 10000, packetsOut: Math.floor(Math.random() * 25000) + 8000, bytesIn: Math.floor(Math.random() * 30000000) + 10000000, bytesOut: Math.floor(Math.random() * 25000000) + 8000000 },
          { rank: 4, ip: '172.217.14.206', hostname: 'google.com', packetsIn: Math.floor(Math.random() * 25000) + 8000, packetsOut: Math.floor(Math.random() * 20000) + 6000, bytesIn: Math.floor(Math.random() * 25000000) + 8000000, bytesOut: Math.floor(Math.random() * 20000000) + 6000000 },
          { rank: 5, ip: '192.168.1.1', hostname: 'gateway', packetsIn: Math.floor(Math.random() * 20000) + 5000, packetsOut: Math.floor(Math.random() * 15000) + 4000, bytesIn: Math.floor(Math.random() * 20000000) + 5000000, bytesOut: Math.floor(Math.random() * 15000000) + 4000000 }
        ]
      }
    }
    ...
    const fetchStatistics = async () => {
      ...
      // Generate local statistics data
      statistics.value = generateStatistics()
    ...
    // Generate random security alerts (sometimes empty for "no threats")
    const securityAlerts = computed(() => {
      const random = Math.random()
      if (random > 0.6) return [] // 40% chance of no alerts

      const alertTypes = [
        { type: 'Port Scan', severity: 'warning', description: 'Multiple connection attempts to different ports detected', source: '192.168.1.105', destination: '192.168.1.50' },
        { type: 'Unusual Traffic', severity: 'info', description: 'High bandwidth usage detected from single host', source: '192.168.1.100', destination: '8.8.8.8' },
        { type: 'DDoS Pattern', severity: 'danger', description: 'Possible DDoS attack pattern - high packet rate to single destination', source: 'Multiple', destination: '192.168.1.1' }
      ]
