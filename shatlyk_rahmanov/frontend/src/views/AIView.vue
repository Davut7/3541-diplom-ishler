  ...
  <div class="ai-view">
    <div class="page-header">
      <div class="header-content">
        <h1><i class="pi pi-microchip-ai"></i> {{ t.ai.title }}</h1>
        <p>{{ t.ai.subtitle }}</p>
      </div>
...
.model-card h3 i { color: var(--fire-orange); }
.learning-card h3 i { color: #8b5cf6; }
.capabilities-card h3 i { color: #22c55e; }
.threats-card h3 i { color: #ef4444; }
.neural-network-card h3 i { color: var(--fire-orange); }
...
@keyframes icon-pulse {
  ...
  50% { box-shadow: 0 0 35px rgba(234, 88, 12, 0.6); }
}
