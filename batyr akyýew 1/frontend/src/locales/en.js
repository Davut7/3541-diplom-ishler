export default {
  ...
  settings: {
    title: 'Settings',
    subtitle: 'Configure WAF system settings',
  ...
  blockedIPs: {
    ...
    subtitle: 'Manage blocked IP addresses and view block statistics',
    addIP: 'Block New IP',
    totalBlocked: 'Total Blocked',
    totalBlocks: 'Total Block Events',
    countries: 'Countries',
    ...
    actions: 'Actions',
    noBlocked: 'No blocked IP addresses',
    addNewIP: 'Block New IP Address',
    blockIP: 'Block IP'
  },
  proxy: {
    title: 'Reverse Proxy Mode',
    subtitle: 'Protect external websites by routing traffic through WAF',
    howItWorks: 'How Reverse Proxy Works',
    howItWorksDesc: 'The WAF acts as a protective layer between clients and your target server. All HTTP requests pass through the WAF where they are analyzed for threats before being forwarded to the actual server.',
    configuration: 'Proxy Configuration',
    targetUrl: 'Target Server URL',
    targetName: 'Target Name',
    proxyPort: 'Proxy Port',
    logRequests: 'Log All Suspicious Requests',
    blockThreats: 'Block Detected Threats',
    saveConfig: 'Save Configuration',
    control: 'Proxy Control',
    running: 'Proxy Running',
    stopped: 'Proxy Stopped',
    stoppedDesc: 'Start the proxy to protect your target server',
    start: 'Start Proxy',
    stop: 'Stop Proxy',
    accessVia: 'Access via',
    accessHint: 'All requests to this URL will be analyzed by WAF before forwarding to target server.',
    integrationCode: 'Integration Options'
  },
  login: {
    subtitle: 'Sign in to access the WAF Dashboard',
