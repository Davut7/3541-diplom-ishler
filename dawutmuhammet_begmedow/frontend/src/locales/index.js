export const translations = {
  en: {
    nav: { home: 'Home', scan: 'Scan', systemScan: 'System Scan', techniques: 'Techniques', statistics: 'Statistics', history: 'History', howItWorks: 'How It Works', about: 'About' },
    ...
    statistics: {
      ...
      subtitle: 'Overview of your scan history and threat analysis',
      cards: { totalScans: 'Total Scans', cleanFiles: 'Clean Files', suspicious: 'Suspicious', malware: 'Malware Detected' },
      charts: { statusDistribution: 'Status Distribution', threatLevels: 'Threat Levels', scanHistory: 'Scan Activity (Last 7 Days)' },
      fileTypes: { title: 'File Types Scanned' },
      patterns: { title: 'Top Suspicious Patterns', noPatterns: 'No suspicious patterns detected yet' }
    },
    systemScan: {
      title: 'System Scan',
      subtitle: 'Scan your entire system for threats',
      quickScan: 'Quick Scan',
      quickDesc: 'Scan common threat locations: Downloads, Desktop, LaunchAgents',
      fullScan: 'Full System Scan',
      fullDesc: 'Deep scan of entire home directory and applications',
      threatsFound: 'Threats Found',
      noThreats: 'No Threats Found',
      scannedFiles: 'Scanned',
      scanAgain: 'Scan Again',
      detectedThreats: 'Detected Threats',
      scannedPaths: 'Scanned Locations',
      electronRequired: 'Electron Required',
      electronRequiredDesc: 'System scanning requires the desktop application. Please run the app in Electron mode.'
    },
    about: {
  ...
  tk: {
    nav: { home: 'Baş sahypa', scan: 'Skanirle', systemScan: 'Ulgam Skani', techniques: 'Usullar', statistics: 'Statistika', history: 'Taryh', howItWorks: 'Nähili işleýär', about: 'Hakynda' },
    ...
    statistics: {
      title: 'Skan Statistikasy',
      subtitle: 'Skan taryhy we howp derňewi',
      cards: { totalScans: 'Jemi Skanlar', cleanFiles: 'Arassa Faýllar', suspicious: 'Şübheli', malware: 'Zyýanly Tapyldy' },
      charts: { statusDistribution: 'Ýagdaý Paýlanyşy', threatLevels: 'Howp Derejeleri', scanHistory: 'Skan Işjeňligi (Soňky 7 Gün)' },
      fileTypes: { title: 'Skanirlen Faýl Görnüşleri' },
      patterns: { title: 'Iň Köp Şübheli Nagyşlar', noPatterns: 'Heniz şübheli nagyş tapylmady' }
    },
    systemScan: {
      title: 'Ulgam Skani',
      subtitle: 'Ulgamyňyzy howplara garşy skanirläň',
      quickScan: 'Çalt Skan',
      quickDesc: 'Umumy howp ýerleri: Ýüklemeler, Iş stoly, LaunchAgentlar',
      fullScan: 'Doly Ulgam Skani',
      fullDesc: 'Öý katalogy we programmalaryň çuňňur skani',
      threatsFound: 'Howp Tapyldy',
      noThreats: 'Howp Tapylmady',
      scannedFiles: 'Skanirlenler',
      scanAgain: 'Täzeden Skanirle',
      detectedThreats: 'Tapylan Howplar',
      scannedPaths: 'Skanirlen Ýerler',
      electronRequired: 'Electron Gerek',
      electronRequiredDesc: 'Ulgam skanirleme üçin desktop programmasy gerek. Programmany Electron režiminde işlediň.'
    },
    about: {
  ...
  ru: {
    nav: { home: 'Главная', scan: 'Сканер', systemScan: 'Системное сканирование', techniques: 'Техники', statistics: 'Статистика', history: 'История', howItWorks: 'Как работает', about: 'О программе' },
    footer: { diploma: 'Дипломный проект', author: 'Автор' },
    home: {
      title: 'Обнаружение вредоносного ПО',
      subtitle: 'Обнаружение вирусов, обходящих антивирусную защиту',
      description: 'Наш инструмент с ИИ использует эвристический анализ, поведенческое обнаружение и безсигнатурные методы для выявления вредоносного ПО, которое не находят обычные антивирусы.',
      startScan: 'Начать сканирование',
      learnMore: 'Изучить техники',
      features: {
        title: 'Методы обнаружения',
        heuristic: { title: 'Эвристический анализ', desc: 'Анализ поведения кода для выявления подозрительной активности' },
        behavioral: { title: 'Поведенческое обнаружение', desc: 'Мониторинг выполнения файлов для обнаружения вредоносного поведения' },
        aiPowered: { title: 'Обнаружение с ИИ', desc: 'Модели машинного обучения, обученные на миллионах образцов' },
        signatureless: { title: 'Безсигнатурное обнаружение', desc: 'Обнаружение угроз нулевого дня без сигнатур вирусов' }
      },
      stats: { filesScanned: 'Файлов просканировано', threatsDetected: 'Угроз обнаружено', evasionTechniques: 'Техник обхода', detectionRate: 'Уровень обнаружения' }
    },
    scan: {
      title: 'Сканер файлов',
      subtitle: 'Сканирование файлов на вредоносное ПО',
      uploadFile: 'Загрузить файл',
      dropzone: 'Выберите файл для сканирования',
      clickOrDrag: 'Нажмите или перетащите файл',
      scanFolder: 'Сканировать папку',
      selectFolder: 'Выберите папку для сканирования',
      scanning: 'Сканирование...',
      folderResults: 'Результаты сканирования папки',
      scannedFiles: 'Файлов просканировано',
      openLocation: 'Открыть расположение',
      saveReport: 'Сохранить в историю',
      settings: 'Настройки',
      results: {
        title: 'Результаты', fileName: 'Имя файла', fileSize: 'Размер', fileType: 'Тип', hash: 'SHA-256', hashes: 'Хеши файла', entropy: 'Энтропия', status: 'Статус', threatLevel: 'Уровень угрозы', threatScore: 'Оценка угрозы', details: 'Детали', suspiciousPatterns: 'Подозрительные шаблоны'
      },
      status: { clean: 'Чисто', suspicious: 'Подозрительно', malware: 'Вредоносное ПО', potentiallyUnwanted: 'Нежелательное ПО' }
    },
    systemScan: {
      title: 'Системное сканирование', subtitle: 'Сканирование всей системы на вредоносное ПО',
      quickScan: 'Быстрое', fullScan: 'Полное', startScan: 'Начать', cancelScan: 'Отмена',
      scanning: 'Сканирование...', complete: 'Завершено', threatsFound: 'Угроз найдено', noThreats: 'Система чиста',
      systemInfo: 'Информация о системе', platform: 'Платформа', hostname: 'Имя хоста', cpus: 'Процессоры', memory: 'Память'
    },
    techniques: {
      title: 'Техники обхода', subtitle: 'Как вредоносное ПО избегает обнаружения',
      detection: 'Метод обнаружения', risk: 'Риск',
      types: {
        polymorphic: { name: 'Полиморфный код', desc: 'Вредоносное ПО меняет свой код при каждом копировании' },
        metamorphic: { name: 'Метаморфный код', desc: 'Полная перезапись кода при каждой итерации' },
        packing: { name: 'Упаковка/Шифрование', desc: 'Сжатие или шифрование вредоносной нагрузки' },
        fileless: { name: 'Безфайловое ПО', desc: 'Работает в памяти без файлов на диске' },
        rootkit: { name: 'Руткиты', desc: 'Скрывается от операционной системы' },
        sandbox: { name: 'Обход песочницы', desc: 'Обнаруживает среды анализа' }
      }
    },
    statistics: {
      title: 'Статистика', subtitle: 'Обзор активности сканирования',
      totalScans: 'Всего сканирований', cleanFiles: 'Чистых файлов', suspiciousFiles: 'Подозрительных', malwareFound: 'Вредоносных',
      charts: { statusDistribution: 'Распределение статусов', severityLevels: 'Уровни угроз', recentActivity: 'Последняя активность' }
    },
    history: {
      title: 'История сканирований', subtitle: 'Все предыдущие результаты сканирования',
      search: 'Поиск по имени файла...', noHistory: 'История пуста', clearAll: 'Очистить всё',
      columns: { date: 'Дата', fileName: 'Файл', status: 'Статус', threatScore: 'Оценка', actions: 'Действия' }
    },
    howItWorks: {
      title: 'Как работает обнаружение', subtitle: 'Процесс анализа вредоносного ПО',
      steps: {
        upload: { title: 'Загрузка файла', desc: 'Загрузите файл или выберите папку' },
        hash: { title: 'Вычисление хешей', desc: 'Расчёт MD5, SHA1, SHA256' },
        entropy: { title: 'Анализ энтропии', desc: 'Обнаружение упакованных/зашифрованных файлов' },
        patterns: { title: 'Сканирование шаблонов', desc: 'Поиск подозрительных строк и API' },
        verdict: { title: 'Вердикт', desc: 'Финальная оценка угрозы' }
      },
      faq: {
        q1: { question: 'Что делает этот инструмент?', answer: 'Анализирует файлы на наличие вредоносного ПО с помощью эвристического анализа, обнаружения шаблонов и расчёта энтропии.' },
        q2: { question: 'Безопасно ли загружать файлы?', answer: 'Да, файлы анализируются локально и удаляются после сканирования.' },
        q3: { question: 'Какие файлы можно сканировать?', answer: 'Любые файлы: исполняемые (.exe, .dll), документы, скрипты, архивы.' },
        q4: { question: 'Нужен ли интернет?', answer: 'Нет, основные функции работают полностью оффлайн.' }
      }
    },
    about: {
      title: 'О программе', subtitle: 'Обнаружение вирусов, обходящих антивирусы',
      description: 'Десктопное приложение для обнаружения вредоносного ПО с помощью вычисления хешей, анализа энтропии и обнаружения шаблонов.',
      features: [ 'Вычисление хешей SHA256/MD5/SHA1', 'Анализ энтропии для обнаружения упаковки', 'Сканирование подозрительных шаблонов', 'Интеграция с ClamAV', 'Сканирование папок', 'Постоянная история сканирований' ],
      author: { title: 'Автор', name: 'Давутмухаммет Бегмедов', project: 'Дипломный проект', topic: 'Обнаружение вирусов, обходящих антивирусную защиту', topicTk: 'Antiwiruslaryň anyklamasyndan gaçýan wirusleri anyklamak we seljermek' }
    }
  }
}
