export default {
  ...
  statistics: {
    ...
    subtitle: 'Overview of scan history and threat analysis',
    cards: {
      totalScans: 'Total Scans',
      threats: 'Threats Detected',
      removed: 'Threats Removed',
      daysProtected: 'Days Protected'
    },
    charts: {
      threatTypes: 'Threat Types',
      riskLevels: 'Risk Levels',
      scanHistory: 'Scan Activity (Last 7 Days)'
    },
    recentDetections: {
      title: 'Recent Detections',
      noDetections: 'No threats detected recently'
    },
    protectionStatus: {
      title: 'Protection Status',
      hookMonitor: 'Hook Monitor',
      apiMonitor: 'API Monitor',
      processGuard: 'Process Guard',
      networkGuard: 'Network Guard'
    }
  },
  about: {
    subtitle: 'Advanced Keylogger Detection for Windows',
    ...
    features: [
      'Real-time keyboard hook monitoring',
