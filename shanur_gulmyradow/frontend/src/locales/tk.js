export default {
  ...
  statistics: {
    title: 'Tor Statistikasy',
    subtitle: 'Hakyky wagtda tor trafigini seljermek we wizualizasiýa'
  },
  home: {
  ...
  about: {
    ...
    features: [
      'Hakyky wagtda paket tutma simulýasiýasy',
      'Protokol seljermesi we dekodirlemesi',
      'Trafik statistikasy we wizualizasiýa',
      'Anomaliýa ýüze çykaryş algoritmleri',
      'Paket süzme mümkinçilikleri',
      'Hex dump görkeziji',
      'OSI model salgylanmasy',
      'Iki dilli interfeýs (EN/TM)'
    ],
    author: {
      title: 'Awtor',
      name: 'Şanur Gulmyradow',
