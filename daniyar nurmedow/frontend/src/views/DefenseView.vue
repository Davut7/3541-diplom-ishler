<template>
  <div class="defense-view">
      ...
      <template #content>
        ...
        <div class="demo-layout">
          <div class="input-section">
            ...
            <Textarea v-model="maliciousInput" rows="3" class="demo-input" :placeholder="'<img src=x onerror=alert(1)>'" />
          </div>
    ...
    <Card class="code-examples-card">
      <template #content>
        <h2><i class="pi pi-code"></i> Defense Code Examples</h2>

        <div class="code-section">
          <h4>1. HTML Entity Encoding (JavaScript)</h4>
          <pre class="code-block">function escapeHtml(text) {
  const map = {
    '&': '&amp;amp;',
    '&lt;': '&amp;lt;',
    '&gt;': '&amp;gt;',
...
// Result: &amp;lt;script&amp;gt;alert("XSS")&amp;lt;/script&amp;gt;</pre>
        </div>

        <div class="code-section">
          <h4>2. DOM Manipulation (Safe Way)</h4>
          <pre class="code-block">// UNSAFE - Don't do this!
...
container.appendChild(div);</pre>
        ...
        <div class="code-section">
          <h4>3. Node.js/Express Middleware</h4>
  ...
  directives: {
    ...
    imgSrc: ["'self'", "data:", "https:"]
        ...
        <div class="code-section">
          ...
          <pre class="code-block">// Whitelist approach - only allow safe characters
...
function isValidUrl(string) {
  ...
  &lt;!-- SAFE: Use DOMPurify with v-html --&gt;
...
export default {
  ...
  setup() {
    const maliciousInput = ref("<scr" + "ipt>alert('XSS')</scr" + "ipt>")
