    ...
    <header class="app-header">
      <div class="header-left">
        <router-link to="/" class="logo">
          <i class="pi pi-key"></i>
          <span>Key<strong>Guard</strong></span>
        </router-link>
      </div>
      <nav class="main-nav">
        <router-link to="/">{{ t.nav.home }}</router-link>
        <router-link to="/scan">{{ t.nav.scan }}</router-link>
        <router-link to="/processes">{{ t.nav.processes }}</router-link>
        <router-link to="/protection">{{ t.nav.protection }}</router-link>
