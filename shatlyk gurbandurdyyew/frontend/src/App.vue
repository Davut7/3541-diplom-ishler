<template>
  <div :class="['app', { 'dark-mode': darkMode }]">
    ...
    <header class="app-header">
      <div class="header-left">
        <router-link to="/" class="logo">
          ...
          <span>AI <strong>Firewall</strong></span>
        </router-link>
      </div>
      <nav class="main-nav">
        <router-link to="/">{{ t.nav.home }}</router-link>
        <router-link to="/rules">{{ t.nav.rules }}</router-link>
        <router-link to="/traffic">{{ t.nav.traffic }}</router-link>
        <router-link to="/ai">{{ t.nav.ai }}</router-link>
    ...
    <footer class="app-footer">
      <p>&copy; 2024 Shatlyk Gurbandurdyyew - Diploma Project</p>
    </footer>
  </div>
</template>
