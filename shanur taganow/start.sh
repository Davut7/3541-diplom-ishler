...
# ============================================
# Wireshark Monitor - PM2 Start Script
# Author: Shanur Taganow
# ============================================

APP_NAME="shanur-wireshark"
...
# Start backend
echo -e "${GREEN}Starting backend on port 7009...${NC}"
cd "$SCRIPT_DIR/backend"
pm2 start npm --name "${APP_NAME}-backend" -- start

# Start frontend
echo -e "${GREEN}Starting frontend on port 7010...${NC}"
