<template>
  <div :class="['app', { 'dark-mode': darkMode }]">
    ...
    <header class="app-header">
      <div class="header-left">
        <router-link to="/" class="logo">
          ...
          <span>Wire<strong>Guard</strong> Monitor</span>
        </router-link>
      </div>
      <nav class="main-nav">
        ...
        <router-link to="/protocols">{{ t.nav.protocols }}</router-link>
        <router-link to="/statistics">{{ t.nav.statistics || 'Statistics' }}</router-link>
    ...
    <footer class="app-footer">
      <p>&copy; 2026 Shanur Gulmyradow - Diploma Project</p>
    </footer>
  </div>
</template>
